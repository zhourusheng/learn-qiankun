...
const CommunicationDemo: React.FC<CommunicationDemoProps> = ({ shared }) => {
  ...
  const sendCustomEvent = () => {
    ...
    console.log(`[子应用1] 发送自定义事件 "${eventName}":`, messageText);
    setMessageText('');
  };
  ...
  const sendBroadcast = () => {
    ...
    console.log('[子应用1] 发送广播消息:', messageText);
    setMessageText('');
  };
  ...
  const updateGlobalState = () => {
    ...
    console.log('[子应用1] 更新全局状态:', messageText);
    setMessageText('');
  };
